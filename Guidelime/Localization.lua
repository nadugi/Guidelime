...
L["ADDED_QUEST_COORDINATES_MESSAGE"] = "%s 퀘스트 좌표가 추가됨."
L["ALL_QUESTS"] = "모두"
L["Alliance"] = "얼라이언스"
L["ARROW"] = "화살표"
L["ARROW_ALPHA"] = "화살표 투명도"
L["ARROW_CURRENT_STEP"] = "현재 단계 따르기"
L["ARROW_GO_TO_INSTANCE"] = "%s로 이동"
L["ARROW_POSITION_REACHED"] = "목표에 당신은 도달했음."
L["ARROW_SIZE"] = "화살표 크기"
L["ARROW_STYLE"] = "화살표 스타일"
L["ARROW_STYLE1"] = "라임"
L["ARROW_STYLE2"] = "화살표"
L["ARROW_TOOLTIP_CORPSE"] = "네 시체로 달려가라"
L["AT"] = "에서" -- (12,34)에서 npc xyz와 같이
L["AUTO_COMPLETE_QUESTS"] = "퀘스트를 자동으로 수락/완료합니다."
L["AUTO_ACCEPT_QUESTS"] = "퀘스트 자동 수락"
L["AUTO_SELECT_FLIGHT"] = "비행 경로 자동 선택"
L["AUTO_TURNIN_QUESTS"] = "퀘스트 자동 실행"
L["AVAILABLE_GUIDES"] = "사용 가능한 가이드"
L["BUTTONS_LEFT"] = "가이드 창 왼쪽"
L["BUTTONS_RIGHT"] = "가이드 창 오른쪽"
L["CATEGORY"] = "범주"
L["CHECK_QUESTS"] = "퀘스트 진행 상황과 Guidelime 퀘스트 데이터베이스 간에 불일치가 감지되었습니다. 이 텍스트를 Discord의 %s에게 비공개 메시지로 보내면 애드온 개선에 도움이 됩니다(원하는 경우 Curseforge의 %s 또는 Reddit의 %s). 매우 감사합니다!"
L["CHECK_QUESTS_COMPLETED"] = "%s 퀘스트 완료"
L["CHECK_QUESTS_NO_INCONSISTENCIES"] = "일관성이 발견되지 않았습니다"
L["CURRENT_GUIDE"] = "현재 가이드"
L["CURRENT_QUESTS"] = "현재 단계에서"
...
L["DATA_SOURCE_TOOLTIP_CLASSIC_CODEX"] = "'ClassicCodex' 애드온이 설치되면 퀘스트 좌표에 대한 데이터 소스로 사용할 수 있습니다.\n퀘스트 몹 스폰 위치와 같은 내부 퀘스트 데이터베이스와 다른 정보를 포함할 수 있습니다."
L["DATA_SOURCE_TOOLTIP_DB"] = "퀘스트 좌표와 같은 정보는 Guidelime에 포함된 내부 데이터베이스만 사용 중입니다.\n새로운 퀘스트가 누락되었을 수 있습니다."
L["DATA_SOURCE_TOOLTIP_QUESTIE"] = "'Questie' 애드온이 설치되면 퀘스트 좌표에 대한 데이터 소스로 사용할 수 있습니다.\n퀘스트 몹 스폰 위치와 같은 내부 퀘스트 데이터베이스와 다른 정보를 포함할 수 있습니다."
L["DEBUGGING"] = "디버깅 모드 활성화"
L["DEBUGGING_OPTIONS"] = "편집/디버깅 옵션"
L["DELETE_GUIDE"] = "가이드 삭제"
L["DETAILS"] = "상세설명"
L["DISCARD_CHANGES"] = "변경 사항을 취소"
L["DISPLAY_DEMO_GUIDES"] = "데모 가이드 표시"
L["DOWNLOAD_FULL_GUIDE"] = "이것은 데모 입니다. 전체 %s-%s 가이드를 얻으려면 가이드 모듈 %s을(를) 설치해야 합니다. %s에서 무료로 다운로드할 수 있습니다."
L["EDIT_GUIDE"] = "가이드 편집"
L["EDIT_KEYBINDINGS"] = "단축키 편집"
L["EDITOR"] = "편집기"
L["EDITOR_TOOLTIP_APPLIES"] = "현재 단계를 적용할 파벌/인종/클래스를 설정합니다.\ne.g.: \"[A Dwarf,Rogue]\""
L["EDITOR_TOOLTIP_DETAILS"] = "자세한 가이드 설명 입력\ne.g.: \"[D 나의 개인 가이드/드워프/시작 지역]\""
L["EDITOR_TOOLTIP_FLY"] = "비행기를 타야 합니다\ni.e.: \"[F]\""
L["EDITOR_TOOLTIP_GET_FLIGHT_POINT"] = "새로운 비행 지점을 찍어야 할 곳.\ni.e.: \"[P]\""
L["EDITOR_TOOLTIP_GOTO"] = "대상 위치의 좌표 추가\ne.g.: \"[G 29.93,71.2 Dun Morogh]\""
L["EDITOR_TOOLTIP_GUIDE_APPLIES"] = "이 가이드가 적용되는 진영/인종/클래스 설정\ne.g.: \"[GA Dwarf,Gnome]\""
L["EDITOR_TOOLTIP_HEARTH"] = "귀환석을 사용할때.\ni.e.: \"[H]\""
L["EDITOR_TOOLTIP_LOC"] = "추가 위치의 좌표 추가\ne.g.: \"[L 29.93,71.2 Dun Morogh]\""
L["EDITOR_TOOLTIP_NAME"] = "가이드의 이름 및 레벨 범위 설정\ne.g.: \"[N1-6Coldridge Valley]\""
L["EDITOR_TOOLTIP_NEXT"] = "현재 가이드에 이어 다음 가이드의 이름 및 레벨 범위 설정\ne.g.: \"[NX6-12Dun Morogh]\""
L["EDITOR_TOOLTIP_OPTIONAL"] = "현재 단계를 선택 사항으로 표시\ni.e.: \"[O]\""
L["EDITOR_TOOLTIP_OPTIONAL_COMPLETE_WITH_NEXT"] = "다음 단계가 완료될 때마다 현재 단계를 자동으로 완료되도록 표시\ni.e.: \"[OC]\""
L["EDITOR_TOOLTIP_QUEST"] = "퀘스트 추가\ne.g.: \"[QA179]\" or \"[QC3361,2 A Refugee's Quandary]\""
L["EDITOR_TOOLTIP_REPAIR"] = "여기서 수리.\ni.e.: \"[R]\""
L["EDITOR_TOOLTIP_SET_HEARTH"] = "여관에 귀환지점으로 지정.\ni.e.: \"[S]\""
L["EDITOR_TOOLTIP_TRAIN"] = "직업상급자를 방문\ni.e.: \"[T]\""
L["EDITOR_TOOLTIP_VENDOR"] = "상점 방문 / resupply here\ni.e.: \"[V]\""
L["EDITOR_TOOLTIP_XP"] = "이 단계에서 특정 레벨/경험치에 도달해야 함.\ne.g.: \"[XP8.5 half way to 9]\""
L["EDITOR_TOOLTIP_ZONE"] = "다음 좌표는 첫 번째 좌표를 제외하고는 필요하지 않습니다. 생략하면 이전 좌표와 동일한 영역에 있는 것으로 간주됩니다. (첫 번째 좌표가 표시되어 있는 한 동일한 맵을 의미하면 다음 좌표가 자동으로 일치합니다.) "
L["ENGLISH_NAME"] = "영어 이름"
L["ERROR_CODE_NOT_RECOGNIZED"] = "%s\" 분석 오류 \": 코드 [%s]이(가) \"%s\" 줄에서 인식되지 않습니다."
L["ERROR_CODE_ZONE_NOT_FOUND"] = "%s\" 분석 오류 \": \"%s\" 줄의 코드 [%s]에서 영역을 찾을 수 없습니다."
L["ERROR_GUIDE_HAS_NO_NAME"] = "가이드 이름이 없음"
L["ERROR_NOT_A_NUMBER"] = "%s은(는) 숫자가 아님"
L["ERROR_OUT_OF_RANGE"] = "%s은(는) %s과(와) %s 사이에 없음"
L["ERROR_QUEST_CLASS_ONLY"] = "이 퀘스트는 다음 클래스 전용임: "
L["ERROR_QUEST_NOT_FOUND"] = "퀘스트 \"%s\"을(를) 찾을 수 없음"
L["ERROR_QUEST_NOT_UNIQUE"] = "하나 이상의 퀘스트 \"%s\"이(가) 있습니다. 다음 ID 중 하나를 입력 바람십시오."
L["ERROR_QUEST_RACE_ONLY"] = "이 퀘스트는 다음 종족 전용입니다: "
L["ERROR_TBC_DATA_SOURCE"] = "이 가이드를 로드하려면 퀘스트 데이터 소스로 추가 애드온이 필요합니다. 옵션으로 이동하여 데이터 소스로 'Questie' 또는 'ClassicCodex'를 선택하십시오."
L["ERROR_TBC_DATA_SOURCE_INSTALL"] = "이 가이드를 로드하려면 퀘스트 데이터 소스로 추가 애드온이 필요합니다. 'Questie' 또는 'ClassicCodex'를 설치하세요."
L["ERROR_ZONE_NOT_FOUND"] = "\"%s\"은(는) 영역이 아닙니다. 다음 영역 이름 중 하나를 입력하십시오. "
L["ESTIMATE"] = "이 위치는 예상 위치일 뿐입니다."
L["GENERAL_OPTIONS"] = "일반 옵션"
L["GOTO_INFO"] = "Coordinates info"
L["GUIDE_FINISHED"] = "현재 가이드가 완료되었습니다. 다른 가이드를 로드하려면 여기를 클릭하세요."
L["GUIDE_FINISHED_NEXT"] = "현재 가이드가 완료되었습니다. %s을(를) 계속하려면 여기를 클릭하십시오."
L["GUIDE_FINISHED_NEXT_ALT"] = "또는 여기를 클릭하여 %s을(를) 계속할 수 있습니다."
L["GUIDE_LIST"] = "다음에서 더 많은 가이드를 사용할 수 있습니다: %s"
L["GUIDE_QUESTS"] = "현재 가이드에서"
L["GUIDE_WINDOW"] = "안내창"
L["HIDE_MAINFRAME"] = "창 숨기기"
L["HIDE_MARKERS_ON"] = "마커 숨기기"
L["Horde"] = "호 드"
L["IMPORT_GUIDE"] = "가이드 가져오기"
L["IMPORT_GUIDE_MESSAGE"] = "일반 텍스트로 작성된 가이드를 가져옵니다. 퀘스트 이름은 따옴표(\"\")로 입력해야 합니다. 올바른 퀘스트 ID를 수동으로 추가해야 하는 경우도 있습니다. ID가 누락되었거나 다른 오류가 있는 줄은 표시됩니다. 오류를 수정하고 다시 가져오면 표시가 제거됩니다."
L["IMPORT_SETTINGS"] = "다른 캐릭터에서 설정 가져오기"
L["LEFT_CLICK"] = "왼쪽 클릭"
L["LEVEL"] = "레벨"
L["LOAD_GUIDE"] = "가이드 읽기"
L["LOAD_MESSAGE"] = "가이드라임: 가이드 \"%s\" 읽기 중"
L["LOCK_ARROW"] = "화살표 잠금 "
L["LOCK_MAINFRAME"] = "창 잠금"
L["MAIN_FRAME_ALPHA"] = "창 투명도"
L["MAIN_FRAME_FONT_SIZE"] = "문자 크기"
L["MAIN_FRAME_HEIGHT"] = "창 높이"
L["MAIN_FRAME_SHOW_SCROLLBAR"] = "스크롤 막대 보기"
L["MAIN_FRAME_WIDTH"] = "창 너비"
L["MAP"] = "지도"
L["MAP_MARKER_ALPHA"] = "지도 마커 투명도 "
L["MAP_MARKER_SIZE"] = "지도 마커 크기"
L["MAP_MARKER_STYLE"] = "지도 마커 스타일"
L["MAP_MARKERS_GOTO"] = "웨이포인트 마커(%s)"
L["MAP_MARKERS_LOC"] = "추가 마커(%s)"
L["MAX_NUM_OF_MARKERS"] = "마커 수\n(0 = 무제한)"
L["MAX_NUM_OF_STEPS"] = "표시된 단계 수\n(0 = 무제한)"
L["MAXIMUM_LEVEL"] = "최대 레벨"
L["MINIMAP"] = "미니맵"
L["MINIMUM_LEVEL"] = "최소 레벨"
L["MISSING_PREQUEST"] = "다음 퀘스트를 완료해야 합니다."
L["MISSING_PREQUESTS"] = "다음 퀘스트를 완료해야 합니다."
L["MORE_POSITIONS"] = "더 많은 위치"
L["NAME"] = "이름"
L["NEXT"] = "다음" -- 다음 퀘스트로
L["NO_GUIDE_LOADED"] = "아직 가이드를 선택하지 않았습니다. 가이드를 로드하여 시작하려면 여기를 클릭하세요."
L["OBJECTIVE"] = "목적"
L["ONLY_WHEN_MAINFRAME_HIDDEN"] = "가이드 창이 숨겨져 있을 때만"
L["OTHER_GUIDES"] = "다른 가이드"
L["OVERWRITE_MSG"] = "기존 가이드 \"%s\"을(를) 덮어쓰시겠습니까?"
L["PART"] = "부분" -- 퀘스트 시리즈에서와 같이: "실종된 외교관" 17부
L["PREVIOUS"] = "이전" -- 이전 퀘스트로
L["QUEST_ACCEPT"] = "수락함"
L["QUEST_ACCEPT_POS"] = "에 의해 시작"
L["QUEST_ADD_COORDINATES"] = "좌표 추가"
L["QUEST_ADD_COORDINATES_TOOLTIP"] = "퀘스트 데이터베이스에 퀘스트 단계 좌표가 있을 경우 해당 단계로 이동이 추가됩니다."
L["QUEST_CHAIN"] = "연쇄 퀘스트"
L["QUEST_COMPLETE"] = "완벽한"
L["QUEST_COMPLETE_POS"] = "완료 대상"
L["QUEST_CONTAINED_IN_GUIDE"] = "이 퀘스트는 현재 가이드의 일부입니다."
L["QUEST_ID"] = "퀘스트 ID"
L["QUEST_ID_TOOLTIP"] = "퀘스트 id. 생략하면 주어진 이름의 퀘스트가 검색됩니다. 이름이 불명확할 수 있으므로 퀘스트 id를 입력해야 할 수 있습니다."
L["QUEST_INFO"] = "퀘스트 정보"
L["QUEST_NAME"] = "퀘스트 이름"
L["QUEST_NAME_TOOLTIP"] = "표시할 이름입니다. 생략하면 퀘스트 이름이 표시됩니다. \"-\"인 경우 텍스트가 표시되지 않습니다."
L["QUEST_NOT_CONTAINED_IN_GUIDE"] = "이 퀘스트는 현재 가이드의 일부가 아닙니다."
L["QUEST_OBJECTIVE"] = "퀘스트 목표"
L["QUEST_OBJECTIVE_TOOLTIP"] = "완료해야 하는 목표의 수(첫 번째는 1, 두 번째는 2, ...). 단일 목표만 추적할 때 지정할 수 있습니다. 생략하면 모든 목표가 필요합니다."
L["QUEST_REQUIRED_LEVEL"] = "%s에 필요한 레벨은 %s입니다."
L["QUEST_S_TOOLTIP"] = "특정 퀘스트를 수락하지 않는 플레이어를 지적할 때만 사용하세요."
L["QUEST_SKIP"] = "건너뛰다"
L["QUEST_TURNIN"] = "돌아간다"
L["QUEST_TURNIN_POS"] = "완료 위치"
L["REMOVE_ALL_COORDINATES"] = "모든 좌표 제거"
L["REMOVE_ALL_COORDINATES_MESSAGE"] = "모든 좌표 단계([G...])가 제거됩니다."
L["REMOVED_COORDINATES_MESSAGE"] = "% 좌표가 제거되었습니다."
L["RESET_GUIDE"] = "리셋 가이드"
L["RESET_POSITION"] = "위치 재설정"
L["RIGHT_CLICK"] = "오른쪽 클릭"
L["SAVE_GUIDE"] = "가이드 저장"
L["SAVE_MSG"] = "가이드 \"%s\"(으)로 저장하시겠습니까?"
L["SELECT_COLORS"] = "색상 선택"
L["SHIFT_LEFT_CLICK"] = "Shift + 좌 클릭"
L["SHIFT_RIGHT_CLICK"] = "Shift + 우 클릭"
L["SHOW_ARROW"] = "화살표 표시"
L["SHOW_COMPLETED_STEPS"] = "완료된 단계 표시"
L["SHOW_DISTANCE"] = "거리 표시"
L["SHOW_GUIDE_TITLE"] = "가이드 제목 표시"
L["SHOW_LINE_NUMBERS"] = "줄 번호 표시"
L["SHOW_MAINFRAME"] = "창 표시"
L["SHOW_MAP"] = "지도에 표시"
L["SHOW_MARKERS_ON"] = "마커 켜기"
L["SHOW_MINIMAP_BUTTON"] = "미니맵 표시 버튼"
L["SHOW_MINIMUM_QUEST_LEVELS"] = "퀘스트 최소 레벨 표시"
...
L["SKIP_CUTSCENES"] = "컷 장면 건너뛰기"
L["SKIPPING_QUEST"] = "이 퀘스트를 건너뛰고 있습니다."
L["STEP_FOLLOWUP_QUEST"] = "%s을(를) 건너뛰면 나중에 다음 퀘스트를 놓치게 됩니다."
L["STEP_FOLLOWUP_QUEST_CONT"] = "나중에 %s을(를) 수행하면 이 퀘스트가 다시 활성화됩니다."
L["STEP_FOLLOWUP_QUESTS"] = "%s을(를) 건너뛰면 나중에 다음 퀘스트를 놓치게 됩니다."
L["STEP_FOLLOWUP_QUESTS_CONT"] = "나중에 %s을(를) 수행하면 이 퀘스트가 다시 활성화됩니다."
L["STEP_MANUAL"] = "이 단계를 완료했으면 여기를 클릭하십시오."
L["STEP_SKIP"] = "이 단계를 건너뛰려면 여기를 클릭하세요."
L["SUGGESTED_LEVEL"] = "추천 레벨"
L["TARGET_1"] = "대상 NPC 1(주어진 NPC 중 하나를 대상으로 하는 데도 사용됨)" -- 키 바인딩 대화 상자의 경우 "대상 NPC 1"에서와 같이
L["TARGET_RAID_MARKERS"] = "대상 NPC에 %s 설정"
L["TARGET_TOOLTIP"] = "대상 %s" -- 버튼 툴팁의 이름으로 "Target Big Bad Wolf"에서와 같이
L["TARGET_X"] = "대상 NPC %d" --키 바인딩 대화 상자의 번호로 "Target NPC 1"에서와 같이
L["TOOLTIP_HINT_KEY_BIND_BUTTON"] = "힌트: 이 버튼을 키 바인딩할 수 있습니다."
L["TYPE"] = "유형" -- 퀘스트의 유형에서와 같이; 엘리트, ...
L["URL"] = "URL"
L["USE_ITEM_X"] = "아이템 사용(또는 주문 시전) %d" -- 단축키 대화 상자에 번호로 "퀘스트 아이템 사용 1 사용"에서와 같이
L["WOWHEAD_OPEN_QUEST"] = "'와우헤드'에서 퀘스트 확인"
L["WOWHEAD_URL_CLASSIC"] = "https://ko.classic.wowhead.com"
L["WOWHEAD_URL_WOTLK"] = "https://www.wowhead.com/wotlk/ko"
L["XP_LEVEL"] = "레벨만"
L["XP_LEVEL%"] = "백분율"
L["XP_LEVEL%_TOOLTIP"] = "플레이어는 지정된 레벨에 도달해야 하며 다음 레벨을 위해 지정된 비율의 경험치를 획득해야 합니다."
L["XP_LEVEL+"] = "획득 경험치"
L["XP_LEVEL+_TOOLTIP"] = "플레이어는 지정된 레벨에 도달해야 하며 지정된 양의 경험치를 획득해야 합니다."
L["XP_LEVEL-"] = "남은 경험치"
L["XP_LEVEL-_TOOLTIP"] = "플레이어는 지정된 레벨에 도달할 때까지 지정된 경험치만큼 남아 있어야 합니다."
L["XP_TEXT"] = "XP_문자"
L["XP_TEXT_TOOLTIP"] = "표시할 텍스트입니다. 생략하면 이 요소는 \"%s\"로 표시됩니다."
L["YARDS"] = "야드"
L["ZONE"] = "지역"
